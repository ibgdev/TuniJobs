 ...
 */
class CompanyUserRepository extends ServiceEntityRepository implements PasswordUpgraderInterface
{
    ...
    public function findUsersWithoutCompany()
    {
        return $this->createQueryBuilder('cu')
            ->where('cu.company IS NULL') // No company associated
            ->getQuery()
            ->getResult();
    }
